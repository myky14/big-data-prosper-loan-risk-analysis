...
OUTPUT_ROOT = os.path.join("outputs", "04_eda")
...
def main():
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(FIGURES_DIR, "loan_outcome_distribution.png"), dpi=300)
    plt.close()
    print(
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(FIGURES_DIR, "loan_status_distribution.png"), dpi=300)
    plt.close()
    print(
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(FIGURES_DIR, "income_range_distribution.png"), dpi=300)
    plt.close()
    print(
    ...
    plt.ylabel("Count")
    plt.tight_layout()
    plt.savefig(os.path.join(FIGURES_DIR, "prosper_score_distribution.png"), dpi=300)
    plt.close()
    print(
    ...
    plt.ylabel("Feature")
    plt.tight_layout()
    plt.savefig(os.path.join(FIGURES_DIR, "missing_value_distribution.png"), dpi=300)
    plt.close()
    print(
    ...
    if target_col not in numeric_features:
        ...
        plt.tight_layout()
        plt.savefig(
            os.path.join(FIGURES_DIR, "correlation_with_borrower_apr.png"),
            dpi=300,
            bbox_inches="tight",
        )
        plt.close()
        ...
        plt.tight_layout()
        plt.savefig(
            os.path.join(FIGURES_DIR, "correlation_matrix_heatmap.png"),
            dpi=300,
            bbox_inches="tight",
        )
        plt.close()
